  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        hindi: ['Noto Sans Devanagari', 'Inter', '-apple-system', 'BlinkMacSystemFont', 'sans-serif'],
        'hindi-decorative': ['Tiro Devanagari Hindi', 'Noto Sans Devanagari', 'serif'],
      },
      colors: {
      ...
      animation: {
        ...
        "accordion-up": "accordion-up 0.15s cubic-bezier(0.32, 0.72, 0, 1)",
        ...
        "content-show": "content-show 0.2s cubic-bezier(0.32, 0.72, 0, 1)",
        "content-hide": "content-hide 0.15s cubic-bezier(0.32, 0.72, 0, 1)",
      },
    },
  },
